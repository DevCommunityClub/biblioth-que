...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <h1 class="text-light"><a href="index.html">Bibliothèque de Dugny</a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li class="drop-down"><a href="#">Bibliothèque</a>
            <ul>
          ...
          <li><a href="pricing.html">réservation</a></li>

          <li class="get-started"><a href="#get-started">Informations</a></li>
        </ul>
      </nav><!-- .nav-menu -->
